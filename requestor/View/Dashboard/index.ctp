	...
	<div class="row">
		...
		<div class="col-lg-3">
			<div class="ibox ">
				<div class="ibox-title">
					<div class="ibox-tools">
						<span class="label label-danger float-right">Declined</span>
					</div>
					<h5>Income</h5>
				</div>
				<div class="ibox-content">
					...
					<table class="table table-hover no-margins">
						...
						<tbody>
							<tr>
								...
								<td>Fritz Gerald Dumdum</td>
								<td>2020/20/7</td>
								<td><span class="label label-warning"><small>Canceled</small></span> </td>
							</tr>
						</tbody>
					</table>
				</div>
